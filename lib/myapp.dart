...
import 'package:aoyanews/widgets/refresh_glowindicator.dart';
        ...
        child: Consumer<ThemeProvider>(
          builder: (context, provider, __) {
            return RefreshConfiguration(
                ...
                dragSpeedRatio: 0.91,
                headerBuilder: () => GifHeader1(), //MaterialClassicHeader(),
...
//              checkerboardOffscreenLayers: true, // 检查离屏渲染
                  ...
                  navigatorObservers: [
                    AutoDismissKeyboard.routeObserver,
                    WebViewPage.routeObserver,
                  ],
