...
final DecorationTween _kDimTween = DecorationTween(
  begin: const BoxDecoration(), // No decoration initially.
  end: const BoxDecoration(color: Color(0x38000000)),
);
...
class CupertinoPageTransition extends StatelessWidget {
  ...
  CupertinoPageTransition({
    ...
    @required bool linearTransition,
        ...
        _secondaryDimAnimation = (linearTransition
                ? secondaryRouteAnimation
                : CurvedAnimation(
                    parent: secondaryRouteAnimation,
                    curve: Curves.linearToEaseOut,
  ...
  final Animation<Decoration> _secondaryDimAnimation;
    ...
    return SlideTransition(
      ...
      child: SlideTransition(
        ...
        child: DecoratedBoxTransition(
          ...
          decoration: _secondaryDimAnimation,
          child: child,
        ),
      ),
    );
