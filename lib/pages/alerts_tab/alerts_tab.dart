...
import 'package:extended_nested_scroll_view/extended_nested_scroll_view.dart'
    as extended;
import 'package:aoyanews/widgets/custom_tabbarview.dart';
import 'dart:math' as math;

class AlertsTabPage extends StatefulWidget {
  AlertsTabPage({Key key}) : super(key: key);
          ...
          return <Widget>[
            SliverPersistentHeader(
                ...
                delegate: CustomSliverPersistentHeaderDelegate(
                    floatHeight: 0,
                    fixedHeight: 50 + MediaQuery.of(context).padding.top,
                    topWidget: Row(
...
class CustomSliverPersistentHeaderDelegate
  ...
  CustomSliverPersistentHeaderDelegate(
      {this.floatHeight, this.fixedHeight, this.topWidget, this.bottomWidgte});

  ///扩张时0->1
  double percentWithExpand(double shrinkOffset) {
    return (this.maxExtent - this.minExtent - shrinkOffset) /
              ...
              child: Column(
                ...
                children: <Widget>[
                  Transform.translate(
                      ...
                      child: Opacity(
                        opacity: 1,
                        //percentWithExpand(shrinkOffset).clamp(0.0, 1.0),
                        child: topWidget,
                      ))
                ],
              ),
